...
${CATEGORY_ONE}    //*[@id="category-139"]/a
${CATEGORY_TWO}    //*[@id="category-114"]/a
${PRODUCT_ONE}     //*[@id="js-product-list"]/div[1]/div[1]/article/div/div[2]/h2/a
${PRODUCT_TWO}     //*[@id="js-product-list"]/div[1]/div[1]/article/div/div[2]/h2/a
...
Open Home Page
    ...
    Wait Until Page Contains    Custom Text Block    10
...
Add 10 Products To Cart From Two Categories
    Click Element                       xpath=${CATEGORY_ONE}
    Wait Until Page Contains            Sort by    100
    Click Element                       xpath=${PRODUCT_ONE}
    Wait Until Page Contains            Quantity
    
    Add Product To Cart                 3
    
    Click Element                       xpath=${CATEGORY_TWO}
    Wait Until Page Contains            Sort by    100
...
Search By Name And Add One Random Product
    Input Text                      //*[@id="search_widget"]/form/input[2]  guzik
    Press Keys                      //*[@id="search_widget"]/form/input[2]  ENTER
    Wait Until Page Contains        Search results  150
...
Register New Account
    ...
    Click Element                               //*[@id="_desktop_logo"]/h1/a
    sleep   10
...
Make Order
    ...
    Click Button                                //*[@id="delivery_option_6"]
    ...
    Wait Until Page Contains                    Order history  10
...
Cart Test
    ...
    Register New Account
    Remove Three Products From Cart
    Wait Until Keyword Succeeds    45 sec   1 sec   Check Amount In Cart    8
    Make Order